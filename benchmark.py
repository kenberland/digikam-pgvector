...
def main():
    ...
    try:
        ...
        for i in range(num_runs):
            ...
            rand_cursor.execute(
                f"SELECT imageid, matrix FROM ImageHaarMatrix LIMIT 1 OFFSET {random_offset}"
            )
            ...
            print(f" mysql top 10: {mysql_top_10_ids}")
            print(f" postgres top 10: {postgres_top_10_ids}")
